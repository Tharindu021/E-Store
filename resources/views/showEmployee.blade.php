...
<body>
    ...
    <div class="container text-center">
        ...
        <div class="border border-dark w-75"style="height: 500px;">
                <h2 class="text-dark">Details Of Employees</h2>
                @if($data)
                <br><br>
                   <span class="fs-4"> Name:{{$data->name}}</span><br><br>
                   <span class="fs-4">Email:{{$data->email}}</span><br><br>
                   <span class="fs-4">Gender:{{$data->gender}}</span><br><br>
                   <span class="fs-4">Address:{{$data->address}}</span><br><br>
                   <span class="fs-4">Mobile No:{{$data->tp}}</span><br><br>
                @endif
        </div>
    </div>
    @else
